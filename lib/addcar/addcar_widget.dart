                                                  ...
                                                  child: ClipRRect(
                                                    ...
                                                    child: Image.network(
                                                      valueOrDefault<String>(
                                                        _model.uploadedFileUrl1,
                                                        'https://izptjbyyibydlsfuaujz.supabase.co/storage/v1/object/public/images/Tap%20to%20upload%20image%20(2).png',
                                                      ),
                                                      width: 300.0,
                                                      height: 200.0,
                                                      fit: BoxFit.contain,
                                        ...
                                        child: Padding(
                                          padding:
                                              EdgeInsetsDirectional.fromSTEB(
                                                  0.0, 4.0, 0.0, 24.0),
                                          child: Text(
                                            'Upload car image and let AI recognize it',
                                            textAlign: TextAlign.start,
                                            ...
                                            onPressed: () async {
                                              ...
                                              if (getJsonField(
                                                    (_model.output?.jsonBody ??
                                                        ''),
                                                    r'''$.detections[0].mmg[0].make_name''',
                                                  ) !=
                                                  null) {
                                                ScaffoldMessenger.of(context)
                                                    .showSnackBar(
                                                ...
                                                ScaffoldMessenger.of(context)
                                                  ...
                                                  SnackBar(
                                                    content: Text(
                                                      'Something went wrong.Try manual upload.',
                                                      style: TextStyle(
                                                        color:
                                                            FlutterFlowTheme.of(
                                                                    context)
                                                                  ...
                                                                  children: [
                                                                    ...
                                                                    Text(
                                                                      getJsonField(
                                                                        (_model.output?.jsonBody ??
                                                                            ''),
                                                                        r'''$.detections[0].mmg[0].model_name''',
                                                                      ).toString(),
                                                                      style: FlutterFlowTheme.of(
                                                                              context)
                                                                          .bodyMedium,
