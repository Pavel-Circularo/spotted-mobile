                    ...
                    child: Padding(
                      ...
                      child: Text(
                        'Profile ${valueOrDefault<String>(
                          profilePageProfilesRow?.username,
                          'User',
                        )}',
                  ...
                  Padding(
                    ...
                    child: FutureBuilder<List<CarsRow>>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        List<CarsRow> containerCarsRowList = snapshot.data!;
                        return Material(
                          color: Colors.transparent,
                          elevation: 50.0,
                          shape: RoundedRectangleBorder(
                                    ...
                                    Align(
                                      ...
                                      child: Padding(
                                        padding: EdgeInsetsDirectional.fromSTEB(
                                            20.0, 0.0, 0.0, 0.0),
                                        child: Text(
                                          'Garage size: ${containerCarsRowList.length.toString()}',
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium,
                                        ),
                                      ),
                                    ),
                                    if (containerCarsRowList.length < 2)
                                      Text(
                                        ' car',
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium,
                                      ),
                                    if (containerCarsRowList.length > 1)
                                      Text(
                                        ' cars',
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium,
                        ...
                        FFButtonWidget(
                          onPressed: () async {
                            ...
                            context.pushNamedAuth(
                                'loginRegisterPage', context.mounted);
                          },
                          text: 'Log out',
                          options: FFButtonOptions(
                            height: 40.0,
